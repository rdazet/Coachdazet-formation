...
export default async function PlanImmoPage() {
  ...
  const iframeSrc = `/plan-immo/index.html?prenom=${prenom}&nom=${nom}`;
    ...
    <div className="flex flex-col">
      <div className="px-6 py-4 border-b border-gray-200 bg-white flex items-center justify-between shrink-0">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Propriétaire ou locataire selon la valeur de la résidence principale</p>
        </div>
      ...
      <AutoResizeFrame src={iframeSrc} title="Plan Immobilier" />
    </div>
  );
}
