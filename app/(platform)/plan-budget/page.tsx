...
export default async function PlanBudgetPage() {
  ...
  const iframeSrc = `/plan-budget/index.html?prenom=${prenom}&nom=${nom}`;
  ...
  return (
    <div className="flex flex-col">
      ...
      <AutoResizeFrame src={iframeSrc} title="Plan Budget" />
    </div>
  );
}
